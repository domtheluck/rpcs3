...
namespace vk
{
	...
	class texture_cache : public rsx::texture_cache<cached_texture_section, vk::image_view, vk::image, VkFormat>
	{
	private:
	...
	public:
				...
				rsx::vk_render_targets &m_rtts, vk_data_heap &upload_heap, vk::buffer* upload_buffer)
		{
			...
			if (!dest_exists)
			{
				dest_texture = new vk::image(*vk::get_current_renderer(), memory_types.host_visible_coherent, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
					VK_IMAGE_TYPE_2D,
					dst_vk_format,
